...
//when post a drink request, this object is used to post your data
...
//when you accept a drink offer, this object is used to post your data
...
//when you make a drink offer, this object is used to post your data
var send_drink_offer_data = {
    "drink_offer_id": "unique identifier generated by database",
    "drink_request_id": "refernce from drink request table",
    "drink_offer_user_id": "person making the drink offer",
    "drink_offer_msg": "message add by drink person making the offer",
    "drink_offer_bid_amount": "amount specified by person or the orginal drink request amout if otherwise"
};

//when you click on a drink offer, this object is used to hold the highest bidder for the drink request from which the offer was made
var highest_bidder = {
...
function render_each_selected_drink_request_user(user_id, name, age, gender, address, picture, cover){
    ...
    selected_drink_request_user_info.innerHTML = `
                    ...
                    <p class="viewFullProfileBtn" onclick="showFullProfileDiv('${name}','${age}','${gender}','${address}','${user_id}','${base64Image}');"
